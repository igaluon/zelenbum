                ...
                <div class="wrapper">
                    <div class="grid_5 alpha rt-indent-bottom-1">
                        <div class="rt-block-indent-2">
                            <h2 class="indent-bot-2">Наши координаты</h2>
                            <div>
                            ...
                            <div>
                                <dl class="adress">
                                    <dt>Украина, Запорожье<br>
                                        Выезд из Запорожья, п. Балабино.</dt>
                                    <dd><span>(067) 700 06 :</span>Телефон:</dd>
                                    <dd><span>(066) 656 77</span>Телефон:</dd>
                    ...
                    <div class="grid_7 omega">
                        <h2 class="indent-bot-2">Напишите нам</h2>
                        <!-- contact form -->
                        <div id="confirm">
                            ...
                            <?= $form->field($model, 'body')->textarea(['placeholder' => 'сообщение'])->label('') ?>

                            <div class="btns">
                                <?= \yii\helpers\Html::submitButton('Отправить', ['class' => 'button']) ?>
                            </div>
